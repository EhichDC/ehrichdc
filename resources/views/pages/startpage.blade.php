                    ...
                    <!--
                                    ...
                                    <div class="row">
                                        <div class="medium-12 columns">
                                            <h1 style="padding-bottom: 25px; padding-top: 25px; font-weight:bold; text-align: center;">
                                                4 wichtige Gründe, warum Sie sich für Padento entscheiden sollten...
                                            </h1>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="medium-8 columns">
                                            <h3 style="font-weight: bold;">1. Das für Sie beste Ergebnis</h3>
                                            <p>Den bestmöglichen Zahnersatz erhalten Sie nur, wenn ein guter Zahnarzt
                                                und ein gutes Dentallabor zusammenarbeiten. Zahntechniker erkennen
                                                anhand der Abdrücke die Qualität eines Zahnarztes sofort. Der
                                                Zahntechnikermeister informiert Sie zum Thema Zahnersatz nach
                                                zahnärztlichen Vorgaben und lädt Sie in sein Dentallabor vor Ort ein.
                                                Nutzen Sie diese Möglichkeit! Die vielen neuen Techniken kann ein
                                                Zahnarzt alleine gar nicht mehr alle zeigen.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="medium-8 columns">
                                            <h3 style="font-weight:bold;">2. Zahnersatz zum Anfassen</h3>
                                            <p>
                                                Damit Sie dieses komplexe Thema wirklich verstehen können, vereinbaren
                                                Sie noch heute einen Termin in einem Padento Dentallabor direkt in Ihrer
                                                Nähe. Danach können Sie eine viel bessere Entscheidungen treffen.
                                                Schließlich wird Ihr „Zahnersatz“ vom Zahntechniker und nicht vom
                                                Zahnarzt
                                                hergestellt. Deshalb sollten Sie sich IMMER aus 2 Perspektiven beraten
                                                lassen: Vom Zahnarzt und vom Zahntechniker.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="medium-8 columns">
                                            <h3 style="font-weight:bold;">3. Sie haben die freie Wahl</h3>
                                            <p>
                                                Lassen Sie sich direkt vom Spezialisten über alle technischen Details zu
                                                Implantaten, Prothesen und anderen Möglichkeiten des Zahnersatzes
                                                umfassend informieren. Die meisten Menschen gehen nach einer Beratung
                                                im Dentallabor zusätzlich zu einem Padento-Zahnarzt, um sich noch eine
                                                zweite Zahnarzt-Meinung zu holen. Sicher ist sicher! Sie haben die freie
                                                Zahnarztwahl und können sich sogar Ihr Dentallabor selbst aussuchen.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="medium-8 columns">
                                            <h3 style="font-weight:bold;">4. Finanzierung und Ratenzahlung</h3>
                                            @if ($lang  == 'de')
                                                <p>
                                                    Es ist heutzutage völlig normal, schöne und wertvolle Dinge zu
                                                    finanzieren.
                                                    Nicht jeder hat ein paar tausend Euro so einfach übrig. Sie können
                                                    bei uns
                                                    ganz einfach und bequem Ihren Eigenanteil finanzieren lassen.
                                                    Bonität
                                                    vorausgesetzt! Freuen Sie sich auf Ihre schönen und neuen Zähne.
                                                    Natürlich
                                                    nur „Made in Germany“.
                                                </p>
                                            @endif
                            ...
                            <div class="row">
                                <div class="small-12 columns">
                                    ...
                                    <p style="text-align:center;">
                                        ...
                                        <strong class="green">die ganzen Erfolgsgeschichten von all den glücklichen
                        ...
                        <section class="cta-row section">
                            ...
                            <div style="width: 80%;margin: auto; margin-top:20px !important; margin-bottom: 20px !important; background-color:#f8f8f7; padding:15px; text-align:center; border-radius:15px;">
                                <span class="green" style="font-weight:bold; text-align:center;">
                                ...
                                <div class="medium-7 columns">
                                    <div class="padento-box">
                                        <div class="padento-box-head">
                                            <p>Nehmen Sie <strong class="green">unbedingt</strong> Ihre Chance wahr und
                                                holen Sie sich eine professionelle
                                                <strong class="green">2.Meinung</strong> beim Zahntechniker und
                                                vielleicht auch bei einem unabhängigen Zahnarzt,
                                                damit Sie wirklich <strong class="green">mitreden</strong> können.</p>
                                        </div>
                                        <div class="padento-box-content">
