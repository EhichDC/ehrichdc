import DentistStats from './dentiststats.template.html';
import Chart from 'chart.js';

export default {
    template: DentistStats,

    components: {},

    data() {
        return {
            sitename: 'Zahnarzt Statistiken',
            labs: [],
            labNames: 'Alle',
            form: {
                start_date: null,
    ...
    methods: {
        fetch() {
            this.$http.post('/api/stats/dentists-contacts', this.form)
                .then(({data}) => {
